...
public class Modbus_CRC16 {
	 ...
	 * @param toSend
	 *            string to be convert
	 * @return buffer with crc word, high byte if after low byte according the
	 *         modbus
	 */
	...
	public static void main2(String[] args) {
		...
		byte[] sbuf2 = Modbus_CRC16.getSendBuf(str);
		System.out.println(Modbus_CRC16.getBufHexStr(sbuf2));
	}
}
