...
public class Modbus_CRC16M {
	...
	public static byte[] getSendBuf(String toSend) {
		...
		Modbus_CRC16M crc16 = new Modbus_CRC16M();
	...
	public static void main2(String[] args) {
		...
		byte[] sbuf = Modbus_CRC16M.getSendBuf("010415000004");
		System.out.println(Modbus_CRC16M.getBufHexStr(sbuf));
	}
}
